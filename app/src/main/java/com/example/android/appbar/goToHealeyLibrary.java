                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.nav_home:
                                Intent intent = new Intent(goToHealeyLibrary.this, MainActivity.class);
                                startActivity(intent);
                                Log.d("UMDine", "Home was clicked ");
                                break;

                            case R.id.nav_restaurant_menu:
                                Intent intent1 = new Intent(goToHealeyLibrary.this, goToCafeListMain.class);
                            ...
                            case R.id.nav_faq:
                                Intent intent4 = new Intent(goToHealeyLibrary.this, goToFAQ.class);
